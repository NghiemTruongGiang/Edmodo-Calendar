...
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.sqlite3', # Add django.db.backends.'postgresql_psycopg2', 'postgresql', 'mysql', 'sqlite3' or 'oracle'.
...
STATICFILES_DIRS = (
	"D:/Program Files/Myweb/mysite/site_media",
...
SECRET_KEY = 'q6$@@12+!r+1(5v5&nq+&1=kw&qd5vbt&o*l9mq38igoimlg_9'
