...
CoolClock.config = {
	...
	skins:	{
		...
		Chrome: {
			outerBorder: { lineWidth: 185, radius: 2, color: "#FFFFFF", alpha: .85 },
			smallIndicator: { lineWidth: 0, startAt: 90, endAt: 94, color: "#FFFFFF", alpha: .85 },
			largeIndicator: { lineWidth: 3, startAt: 84, endAt: 94, color: "#FFFFFF", alpha: .85 },
			hourHand: { lineWidth: 8, startAt: 0, endAt: 50, color: "white", alpha: .85 },
			minuteHand: { lineWidth: 6, startAt: 0, endAt: 70, color: "white", alpha: .85 },
			secondHand: { lineWidth: 2, startAt: 0, endAt: 80, color: "white", alpha: 1 },
			secondDecoration: { lineWidth: 3, startAt: 0, radius: 4, fillColor: "white", color: "white", alpha: .85 }
		},
